...
function jobman_display_jobs( $posts ) {
	...
	if( isset( $wp_query->query_vars['jobman_page'] ) || ( NULL != $post && in_array( $post->post_type, array( 'jobman_job', 'jobman_joblist', 'jobman_app_form' ) ) ) ) {
		if( NULL == $post  || ! in_array( $post->post_type, array( 'jobman_job', 'jobman_joblist', 'jobman_app_form' ) ) ) {
